      ...
      <div className="retro-window w-80 shadow-[2px_2px_10px_rgba(0,0,0,0.5)]" style={{ position: 'relative', margin: 'auto' }}>
        ...
        <div className="retro-titlebar">
          ...
          <div className="flex gap-[2px]">
            <button className="retro-title-btn" onClick={onClose} title="Close">
        ...
        <div className="p-4 flex flex-col gap-4">
          <div className="flex items-start gap-4">
            <span className="text-3xl select-none" style={{ marginTop: '-2px' }}>⚠️</span>
          ...
          <div className="flex justify-center w-full mt-2">
            <RetroButton onClick={onClose} primary className="w-24">OK</RetroButton>
          </div>
        </div>
      </div>
    </div>
